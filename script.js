...
function renderCreators() {
  ...
  creators.forEach(function(c) {
    var avatarHtml = '<div class="creator-avatar ' + c.avatarClass + '">';
    if (c.avatar) {
      avatarHtml += '<img src="' + c.avatar + '" alt="Foto ' + c.name + '" loading="lazy">';
    } else {
      avatarHtml += c.initial;
    }
    avatarHtml += '</div>';

    html += '<div class="creator-card">' + avatarHtml +
