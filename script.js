...
var gameData = [
  ...
  {icon:"🕹️",title:"Game Kriptografi",items:[
    ...
    {num:"02",title:"⚿ RSA Kingdom Defense",description:"Enkripsi & dekripsi pesan rahasia! Caesar, Atbash, Vigenère — 10 level dari mudah ke sulit.",tag:"Enkripsi & Dekripsi",isNew:true,accentColor:"green",file:"game/kriptografi/rsa-kingdom-defense.html"}
  ]}
];
